...
class Picoscope:
    ...
    def openScope(self, bitRes=16, obsDuration=120e-3, sampleFreq=1E4):
        ...
        self.ps.setChannel("A", coupling="DC", VRange=1.0, VOffset=-0.4, enabled=True, BWLimited=True)
...
def measure():
    ...
    for current in np.linspace(0.1, 0.5, num=11, endpoint=True):
        ...
        sweeps_number(2500, log, scope, laserDriver, dataf=dataf, arduino=arduino, thermocouple=False)
